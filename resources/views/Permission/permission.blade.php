...
@section('content')
    <h3 class="text-center">Welcome To Permission Page</h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="permissionbtn">Add Permission</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="container">
                        <form action="" id="permissionform" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="guard_name">Guard Name</label>
                                    <input type="text" name="guard_name" id="editguardpermission" class="form-control">
                                </div>
                            </div>
